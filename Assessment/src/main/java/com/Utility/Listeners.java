...
public class Listeners implements ITestListener{
	...
	public void onTestSuccess(ITestResult result) {
		...
		Reporter.log("<a href=\"E:\\Amazon.png\" target=\"_blank\">Screenshot link</a>");
		Reporter.log("<br>");
		Reporter.log("<a href=\"E:\\Login.png\" target=\"_blank\"><img height=200 width=200 src=\"E:\\\\Selenium\\\\Login.png\"></a>");
